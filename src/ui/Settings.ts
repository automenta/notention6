...
export function createSettings(): HTMLElement {
    ...
    const aiProgressiveForm = createProgressiveForm(aiBasicFields, aiAdvancedFields, {
        persistent: true,
    ...
    const componentCollapsible = createCollapsibleSection(
        ...
        { expanded: false, persistent: true, storageKey: "component-preferences-expanded" }
    );
    ...
    const ontologyCollapsible = createCollapsibleSection(
        ...
        { expanded: false, persistent: true, storageKey: "ontology-modules-expanded" }
    );
    ...
    const templateCollapsible = createCollapsibleSection(
        ...
        { expanded: false, persistent: true, storageKey: "template-management-expanded" }
    );
    ...
    const searchCollapsible = createCollapsibleSection(
        ...
        { expanded: false, persistent: true, storageKey: "advanced-search-expanded" }
    );
