...
class ComponentRegistryClass {
    ...
    getPreferredVariant(typeId: string): ComponentVariant | null {
        ...
        const preferredVariantId = this.preferences.get(typeId) || type.defaultVariant;
    ...
    createComponent(typeId: string, ...args: any[]): HTMLElement | null {
        ...
        try {
            ...
            console.error(`Failed to create component ${typeId}:${variant.id}`, error);
    ...
    private savePreferences(): void {
        try {
            ...
            localStorage.setItem('notention-component-preferences', JSON.stringify(prefs));
        } catch (error) {
